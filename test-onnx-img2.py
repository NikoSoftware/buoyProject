...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="runs/train/train6/weights/best.onnx",
                        help="输入你的 ONNX 模型路径。")
    parser.add_argument("--img", type=str, default=r"datasets/test/20250611213828.png", help="输入图像的路径。")
    parser.add_argument("--conf-thres", type=float, default=0.2, help="置信度阈值")
    parser.add_argument("--iou-thres", type=float, default=0.15, help="NMS IoU 阈值")
